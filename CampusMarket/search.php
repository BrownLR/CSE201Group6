...
<html>
	...
	<body>
		...
		<nav class="w3-sidebar w3-bar-block w3-card w3-top w3-xlarge w3-animate-left" style="display:none;z-index:2;width:40%;min-width:300px" id="mySidebar">
		  ...
		  <a href="http://localhost/Home.php#items" onclick="w3_close()" class="w3-bar-item w3-button">Items</a>
		  <a href="http://localhost/Home.php#add" onclick="w3_close()" class="w3-bar-item w3-button">Add Listing</a>
